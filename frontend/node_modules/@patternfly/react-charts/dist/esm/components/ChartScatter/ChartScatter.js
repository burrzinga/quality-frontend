...
export const ChartScatter = (_a) => {
    ...
    themeVariant, 
    // destructure last
    theme = getTheme(themeColor), size = ({ active }) => (active ? ChartScatterStyles.activeSize : ChartScatterStyles.size) } = _a, rest = __rest(_a, ["containerComponent", "themeColor", "themeVariant", "theme", "size"]);
