...
export declare enum ChartDonutThresholdDonutOrientation {
    left = "left",
    right = "right",
    top = "top"
}
export declare enum ChartDonutThresholdLabelOrientation {
    horizontal = "horizontal",
    vertical = "vertical"
}
export declare enum ChartDonutThresholdLabelPosition {
    centroid = "centroid",
    endAngle = "endAngle",
    startAngle = "startAngle"
}
export declare enum ChartDonutThresholdSortOrder {
    ascending = "ascending",
    descending = "descending"
}
export declare enum ChartDonutThresholdSubTitlePosition {
    bottom = "bottom",
    center = "center",
    right = "right"
}
