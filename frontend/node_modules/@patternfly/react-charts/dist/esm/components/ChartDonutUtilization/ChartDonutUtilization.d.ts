...
import { ChartDonutProps } from '../ChartDonut';
import { ChartThemeDefinition } from '../ChartTheme';
export declare enum ChartDonutUtilizationLabelPosition {
    centroid = "centroid",
    endAngle = "endAngle",
    startAngle = "startAngle"
}
export declare enum ChartDonutUtilizationLegendOrientation {
    horizontal = "horizontal",
    vertical = "vertical"
}
export declare enum ChartDonutUtilizationLegendPosition {
    bottom = "bottom",
    right = "right"
}
export declare enum ChartDonutUtilizationSortOrder {
    ascending = "ascending",
    descending = "descending"
}
export declare enum ChartDonutUtilizationSubTitlePosition {
    bottom = "bottom",
    center = "center",
    right = "right"
}
