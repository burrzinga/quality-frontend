...
import { ChartPieProps } from '../ChartPie';
import { ChartThemeDefinition } from '../ChartTheme';
export declare enum ChartDonutLabelPosition {
    centroid = "centroid",
    endAngle = "endAngle",
    startAngle = "startAngle"
}
export declare enum ChartDonutSortOrder {
    ascending = "ascending",
    descending = "descending"
}
export declare enum ChartDonutSubTitlePosition {
    bottom = "bottom",
    center = "center",
    right = "right"
}
