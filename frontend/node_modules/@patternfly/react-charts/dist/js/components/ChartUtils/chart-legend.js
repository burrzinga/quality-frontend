...
exports.getMaxLegendTextSize = exports.getPieLegendY = exports.getPieLegendX = exports.getChartLegendY = exports.getChartLegendX = exports.getBulletLegendY = exports.getLegendY = exports.getLegendX = exports.getLegendItemsPerRow = exports.doesLegendFit = exports.getLegendDimensions = exports.getComputedLegend = void 0;
 ...
 * @private
 */
const getComputedLegend = ({ allowWrap = true, chartType = 'chart', colorScale, dx = 0, dy = 0, height, legendComponent, padding, patternScale, position = ChartTheme_1.ChartCommonStyles.legend.position, theme, width, 
// destructure last
orientation = theme.legend.orientation }) => {
    ...
    const legendItemsPerRow = allowWrap
        ? (0, exports.getLegendItemsPerRow)({
            chartType,
            dx,
            height,
    ...
    const legendX = (0, exports.getLegendX)({
        chartType,
        dx,
        height,
    ...
    const legendY = (0, exports.getLegendY)({
        chartType,
        dy,
        height,
        legendData: legendPositionProps.data,
...
const doesLegendFit = ({ dx = 0, height, legendPosition, legendData, legendOrientation, legendProps, padding, theme, width }) => {
    ...
    switch (legendPosition) {
        case 'bottom-left':
            ...
            break;
        case 'right':
            occupiedWidth = chartSize.width + ChartTheme_1.ChartCommonStyles.legend.margin + left + dx;
            break;
        default:
            occupiedWidth = dx;
            break;
...
const getLegendItemsPerRow = ({ dx, height, legendPosition, legendData, legendOrientation, legendProps, padding, theme, width }) => {
    ...
    for (let i = itemsPerRow; i > 0; i--) {
        const fits = (0, exports.doesLegendFit)({
            dx,
            height,
            legendPosition,
            legendData,
...
const getLegendX = (_a) => {
    ...
    return chartType === 'pie' ? (0, exports.getPieLegendX)(rest) : (0, exports.getChartLegendX)(rest);
};
...
const getLegendY = (_a) => {
    ...
    switch (chartType) {
        case 'pie':
            return (0, exports.getPieLegendY)(rest);
        case 'bullet':
            return (0, exports.getBulletLegendY)(rest);
        default:
            return (0, exports.getChartLegendY)(rest);
    }
};
...
exports.getMaxLegendTextSize = getMaxLegendTextSize;
