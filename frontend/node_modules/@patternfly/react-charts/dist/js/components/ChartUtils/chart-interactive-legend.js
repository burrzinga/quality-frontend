                            ...
                            mutation: (props) => isDataHidden(props.data)
                                ...
                                : {
                                    ...
                                    style: props.slice !== undefined // Support for pie chart
                                        ? Object.assign(Object.assign(Object.assign({}, victory_core_1.Helpers.evaluateStyle(props.style, props)), (index !== props.slice.index && { opacity: chart_area_Opacity_1.default.value })), (props.data[props.slice.index]._fill && {
                                            fill: props.data[props.slice.index]._fill
                                        })) : Object.assign(Object.assign({}, victory_core_1.Helpers.evaluateStyle(props.style, props)), { opacity: chart_area_Opacity_1.default.value })
                                }
                        },
                        {
                            ...
                            mutation: (props) => isHidden(props.index)
                                ...
                                : {
                                    // Skip if hidden
                                    style: Object.assign(Object.assign({}, victory_core_1.Helpers.evaluateStyle(props.style, props)), { opacity: chart_area_Opacity_1.default.value })
                                }
                        },
                        {
