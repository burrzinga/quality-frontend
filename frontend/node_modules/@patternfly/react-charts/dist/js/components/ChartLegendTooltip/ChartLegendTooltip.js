...
const ChartLegendTooltip = (_a) => {
    var { activePoints, datum, center = { x: 0, y: 0 }, flyoutHeight, flyoutWidth, height, isCursorTooltip = true, labelComponent = React.createElement(ChartLegendTooltipContent_1.ChartLegendTooltipContent, null), legendData, patternScale, text, themeColor, 
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
    themeVariant, title, width, 
    // destructure last
    theme = (0, ChartUtils_1.getTheme)(themeColor) } = _a, rest = tslib_1.__rest(_a, ["activePoints", "datum", "center", "flyoutHeight", "flyoutWidth", "height", "isCursorTooltip", "labelComponent", "legendData", "patternScale", "text", "themeColor", "themeVariant", "title", "width", "theme"]);
    ...
    const legendTooltipProps = () => ({
        legendData: (0, ChartUtils_1.getLegendTooltipVisibleData)({ activePoints, legendData, text, theme }),
        legendProps: (0, ChartUtils_1.getLegendTooltipDataProps)(labelComponent.props.legendComponent ? labelComponent.props.legendComponent.props : undefined),
    ...
    const getTooltipComponent = () => {
        ...
        const legendSize = (0, ChartUtils_1.getLegendTooltipSize)(legendTooltipProps());
