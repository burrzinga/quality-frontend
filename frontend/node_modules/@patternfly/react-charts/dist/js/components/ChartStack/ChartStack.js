...
const ChartStack = (_a) => {
    ...
    const { defaultPatternScale } = (0, ChartUtils_1.useDefaultPatternProps)({
        colorScale,
        hasPatterns,
        patternScale,
    ...
    return (React.createElement(victory_stack_1.VictoryStack, Object.assign({ colorScale: colorScale, containerComponent: container, theme: theme }, rest), (0, ChartUtils_1.renderChildrenWithPatterns)({
        children,
