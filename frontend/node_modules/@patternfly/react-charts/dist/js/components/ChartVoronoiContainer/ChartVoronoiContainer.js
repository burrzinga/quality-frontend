...
const ChartVoronoiContainer = (_a) => {
    ...
    themeVariant, 
    // destructure last
    theme = (0, ChartUtils_1.getTheme)(themeColor), labelComponent = React.createElement(ChartTooltip_1.ChartTooltip, null) } = _a, // Note that Victory provides its own tooltip component here
