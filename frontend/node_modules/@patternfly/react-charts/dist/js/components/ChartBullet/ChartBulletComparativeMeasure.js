...
themeVariant, y, 
// destructure last
theme = (0, ChartUtils_1.getBulletComparativeMeasureTheme)(themeColor), height = theme.bar.height, width = theme.bar.width, labelComponent = React.createElement(ChartTooltip_1.ChartTooltip, null) }) => {
    const computedData = (0, utils_1.getComparativeMeasureData)({
        data,
        theme,
        y
    });
