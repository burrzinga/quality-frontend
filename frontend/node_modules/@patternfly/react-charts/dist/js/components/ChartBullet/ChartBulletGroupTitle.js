...
const ChartBulletGroupTitle = ({ ariaDesc, ariaTitle, capHeight = 1.1, dividerComponent = React.createElement(victory_core_1.Line, null), padding, standalone = true, subTitle, themeColor, 
// eslint-disable-next-line @typescript-eslint/no-unused-vars
themeVariant, title, titleComponent = React.createElement(ChartLabel_1.ChartLabel, null), 
// destructure last
theme = (0, ChartUtils_1.getBulletGroupTitleTheme)(themeColor), height = theme.chart.height, width = theme.chart.width }) => {
    ...
    const labelPadding = {
        bottom: (0, ChartUtils_1.getPaddingForSide)('bottom', padding, Number(theme.legend.style.labels.padding)),
        left: (0, ChartUtils_1.getPaddingForSide)('left', padding, Number(theme.legend.style.labels.padding)),
        right: (0, ChartUtils_1.getPaddingForSide)('right', padding, Number(theme.legend.style.labels.padding)),
        top: (0, ChartUtils_1.getPaddingForSide)('top', padding, Number(theme.legend.style.labels.padding))
    };
    // Horizontal divider to render under the group title
    const getDivider = () => {
        const titleSize = (0, ChartUtils_1.getLabelTextSize)({ text: title, theme });
        const subTitleSize = (0, ChartUtils_1.getLabelTextSize)({ text: subTitle, theme });
    ...
    const getTitle = () => {
        ...
        return React.cloneElement(titleComponent, Object.assign(Object.assign(Object.assign({}, (showBoth && { capHeight })), { style: [ChartTheme_1.ChartBulletStyles.label.groupTitle, ChartTheme_1.ChartBulletStyles.label.subTitle], text: showBoth ? [title, subTitle] : title, textAnchor: 'middle', verticalAnchor: 'middle', x: (0, ChartUtils_1.getBulletLabelX)({
                chartWidth: width,
                labelPosition: 'top'
            }), y: (0, ChartUtils_1.getBulletLabelY)({
                chartHeight: height,
