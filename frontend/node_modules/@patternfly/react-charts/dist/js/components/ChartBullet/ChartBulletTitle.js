...
const ChartBulletTitle = ({ ariaDesc, ariaTitle, capHeight = 1.1, horizontal = true, legendPosition = 'bottom', padding, standalone = true, subTitle, themeColor, 
// eslint-disable-next-line @typescript-eslint/no-unused-vars
themeVariant, title, titleComponent = React.createElement(ChartLabel_1.ChartLabel, null), titlePosition, 
// destructure last
theme = (0, ChartUtils_1.getBulletTheme)(themeColor), height = horizontal ? theme.chart.height : theme.chart.width, width = horizontal ? theme.chart.width : theme.chart.height }) => {
    const chartSize = {
    ...
    const getTitle = () => {
        ...
        return React.cloneElement(titleComponent, Object.assign(Object.assign(Object.assign({}, (showBoth && { capHeight })), { style: [ChartTheme_1.ChartBulletStyles.label.title, ChartTheme_1.ChartBulletStyles.label.subTitle], text: showBoth ? [title, subTitle] : title, textAnchor, verticalAnchor: labelPosition === 'top-left' ? 'end' : 'middle', 
            // Adjust for padding
            x: horizontal
                ? (0, ChartUtils_1.getBulletLabelX)({
                ...
                : defaultPadding.left * 0.5 +
                    ...
                    ChartTheme_1.ChartBulletStyles.qualitativeRangeWidth / 2, y: (0, ChartUtils_1.getBulletLabelY)({
