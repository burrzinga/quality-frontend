...
// destructure last
theme = (0, ChartUtils_1.getBulletComparativeErrorMeasureTheme)(themeColor) }) => (0, exports.scaleBarWidth)({
...
// destructure last
theme = (0, ChartUtils_1.getBulletComparativeMeasureTheme)(themeColor) }) => (0, exports.scaleBarWidth)({
    defaultSize: theme.bar.height,
    height,
    horizontal,
...
// destructure last
theme = (0, ChartUtils_1.getBulletComparativeWarningMeasureTheme)(themeColor) }) => (0, exports.scaleBarWidth)({
    defaultSize: theme.bar.height,
    height,
    horizontal,
...
// destructure last
theme = (0, ChartUtils_1.getBulletPrimaryDotMeasureTheme)(themeColor) }) => (0, exports.scaleSize)({
...
// destructure last
theme = (0, ChartUtils_1.getBulletPrimarySegmentedMeasureTheme)(themeColor) }) => (0, exports.scaleBarWidth)({
    defaultSize: theme.group.height,
    height,
    horizontal,
    scale: 0.3,
...
// destructure last
theme = (0, ChartUtils_1.getBulletQualitativeRangeTheme)(themeColor) }) => (0, exports.scaleBarWidth)({
    defaultSize: theme.group.height,
    height,
    horizontal,
