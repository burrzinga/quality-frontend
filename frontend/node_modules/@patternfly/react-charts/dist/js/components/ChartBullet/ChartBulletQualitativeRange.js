...
const ChartBulletQualitativeRange = ({ allowTooltip = true, ariaDesc, ariaTitle, barWidth = ChartTheme_1.ChartBulletStyles.qualitativeRangeWidth, constrainToVisibleArea = false, data, domain, horizontal = true, invert = false, labels, measureComponent = React.createElement(ChartBar_1.ChartBar, null), padding, standalone = true, themeColor, 
// eslint-disable-next-line @typescript-eslint/no-unused-vars
themeVariant, y, y0, 
// destructure last
theme = (0, ChartUtils_1.getBulletQualitativeRangeTheme)(themeColor), height = theme.group.height, width = theme.group.width, labelComponent = React.createElement(ChartTooltip_1.ChartTooltip, null) }) => {
    const computedData = (0, utils_1.getQualitativeRangeData)({
        data,
        invert,
        theme,
        y,
