...
const ChartTooltip = (_a) => {
    ...
    themeVariant, 
    // destructure last
    theme = (0, ChartUtils_1.getTheme)(themeColor) } = _a, rest = tslib_1.__rest(_a, ["constrainToVisibleArea", "labelComponent", "labelTextAnchor", "themeColor", "themeVariant", "theme"]);
...
(0, hoist_non_react_statics_1.default)(exports.ChartTooltip, victory_tooltip_1.VictoryTooltip);
