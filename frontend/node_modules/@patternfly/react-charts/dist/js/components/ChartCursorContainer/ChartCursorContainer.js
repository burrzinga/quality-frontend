...
const ChartCursorContainer = (_a) => {
    var { className, cursorComponent = React.createElement(victory_core_1.LineSegment, null), themeColor, 
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
    themeVariant, 
    // destructure last
    theme = (0, ChartUtils_1.getTheme)(themeColor), cursorLabelComponent = React.createElement(ChartLabel_1.ChartLabel, null) } = _a, // Note that Victory provides its own label component here
    rest = tslib_1.__rest(_a, ["className", "cursorComponent", "themeColor", "themeVariant", "theme", "cursorLabelComponent"]);
    const chartClassName = (0, ChartUtils_1.getClassName)({ className });
    ...
    const cursor = React.cloneElement(cursorComponent, Object.assign({ style: {
            strokeColor: chart_global_label_Fill_1.default.var
    ...
    React.createElement(victory_cursor_container_1.VictoryCursorContainer, Object.assign({ className: chartClassName, cursorComponent: cursor, cursorLabelComponent: chartCursorLabelComponent, theme: theme }, rest)));
};
...
(0, hoist_non_react_statics_1.default)(exports.ChartCursorContainer, victory_cursor_container_1.VictoryCursorContainer);
