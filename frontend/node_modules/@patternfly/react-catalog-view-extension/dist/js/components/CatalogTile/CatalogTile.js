...
class CatalogTile extends React.Component {
    ...
    render() {
        ...
        return (React.createElement(react_core_1.Card, Object.assign({ component: href || onClick ? 'a' : 'div', id: id, href: href || '#', className: (0, react_styles_1.css)('catalog-tile-pf', { featured }, className), onClick: e => this.handleClick(e), isSelectable: true }, props),
            ...
            (description || children) && (React.createElement(react_core_1.CardBody, { className: "catalog-tile-pf-body" },
                description && (React.createElement("div", { className: "catalog-tile-pf-description" },
                    React.createElement("span", { className: (0, react_styles_1.css)({ 'has-footer': footer }) }, description))),
                children)),
