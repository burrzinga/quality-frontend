...
const FilterSidePanelCategory = (_a) => {
    ...
    const classes = (0, react_styles_1.css)('filter-panel-pf-category', className);
    const childrenArray = (0, util_1.childrenToArray)(children);
    ...
    return (React.createElement("form", Object.assign({ className: classes }, props),
        React.createElement("fieldset", { className: `${(0, react_styles_1.css)(form_1.default.formFieldset)} filter-panel-pf-category-items` },
