...
exports.childrenToArray = exports.getUniqueId = void 0;
 ...
 */
const childrenToArray = (children) => children && React.Children.count(children) > 0 && React.Children.toArray(children);
